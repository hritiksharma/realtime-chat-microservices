...
import { ArrowRight, ChevronLeft, Loader2, Lock, LockIcon } from "lucide-react";
      ...
      <div className="max-w-md w-full">
        <div className="bg-gray-800 border border-gray-700 rounded-lg p-8">
          <div className="text-center mb-8">
            <div>
              <div className="mx-auto w-20 h-20 bg-blue-600 rounded-lg flex items-center justify-center mb-6 relative">
                <button
              ...
              <div>
                ...
                {otp.map((digit, index) => (
                  <input
                    ...
                    className="w-12 h-12 ml-2 text-center text-xl font-bold border-2 border-gray-600 rounded-lg bg-gray-700 text-white"
                  />
                ))}
                {error && (
